  ...
  <footer class="bg-gray-800 text-white mt-12">
    <div class="container-custom py-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-lg font-semibold mb-4">ShopVue</h3>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="#" class="text-gray-300 hover:text-white">Clothing</a></li>
            <li><a href="#" class="text-gray-300 hover:text-white">Footwear</a></li>
            <li><a href="#" class="text-gray-300 hover:text-white">Accessories</a></li>
            <li><a href="#" class="text-gray-300 hover:text-white">Electronics</a></li>
          </ul>
        </div>
          ...
          <div class="mt-4">
            ...
            <form class="flex">
              <input
                ...
                class="px-3 py-2 text-gray-900 rounded-l-md focus:outline-none"
              />
              <button
                type="submit"
                class="bg-primary px-3 py-2 rounded-r-md hover:bg-primary/90"
              >
                Subscribe
              </button>
            </form>
      ...
      <div class="border-t border-gray-700 mt-8 pt-6 text-center text-gray-300">
        <p>&copy; 2025 ShopVue. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>